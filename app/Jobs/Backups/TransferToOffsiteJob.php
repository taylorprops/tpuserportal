...
class TransferToOffsiteJob implements ShouldQueue
{
    ...
    {
        // transfer database
        exec('rsync -chavzP -e "ssh -o StrictHostKeyChecking=no -i /home/ds47655/.ssh/id-rsa" --delete --ignore-existing --stats /mnt/vol2/backups/ --exclude "scripts" mike@162.244.66.22:/mnt/sdb/storage/mysql', $output);
