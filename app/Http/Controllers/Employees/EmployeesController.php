...
class EmployeesController extends Controller
{
    ...
    public function profile(Request $request)
    {
        ...
        } elseif ($emp_type == 'transaction_coordinator') {
    ...
    public function get_notes(Request $request)
    {
        ...
        $notes = EmployeesNotes::where('emp_id', $request -> emp_id)
        -> where('emp_type', $request -> emp_type)
        -> with(['user'])
        -> orderBy('created_at', 'desc')
        -> get();

        return view('employees/notes/get_notes_html', compact('notes'));
    }
    ...
    {
        EmployeesNotes::find($request -> id) -> delete();
    }
    ...
    public function import_los(Request $request)
    {
        ...
        foreach ($old_los as $lo) {
            ...
            $add_lo -> commission_percent = (float) $lo -> comm_split * 100;
