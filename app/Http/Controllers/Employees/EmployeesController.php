...
class EmployeesController extends Controller
{
    ...
    public function get_agents(Request $request) {
        ...
        $button_classes = 'px-3 py-2 text-sm bg-primary hover:bg-primary-dark active:bg-primary-dark focus:border-primary-dark ring-primary-dark inline-flex items-center rounded text-white shadow hover:shadow-lg outline-none tracking-wider focus:outline-none focus:ring disabled:opacity-25 transition-all ease-in-out duration-150 shadow hover:shadow-md';
