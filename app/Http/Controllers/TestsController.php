...
class TestsController extends Controller
{
    ...
    public function test(Request $request) {
        ...
        exec("rsync -chavzPO -e 'ssh -l user -i /home/ds47655/.ssh/id_rsa'  --delete --ignore-existing --stats /mnt/vol2/backups/ --exclude 'scripts' root@162.244.66.22:/mnt/sdb/storage/mysql 2>&1", $output);
