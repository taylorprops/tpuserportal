...
class TestsController extends Controller
{
    ...
    public function test(Request $request) {
        ...
        exec('/usr/bin/rsync -chavzPO -e "ssh -o StrictHostKeyChecking=no" --no-perms --no-group --no-owner  --delete --ignore-existing --stats /mnt/vol2/backups/ --exclude "scripts" root@162.244.66.22:/mnt/sdb/storage/mysql 2>&1', $output);
