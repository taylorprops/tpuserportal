...
Route::middleware(['auth', 'web']) -> group(function () {
    ...
    Route::get('/heritage_financial/get_loans', [LoansController::class, 'get_loans']) -> middleware(['loan_officer']);
    Route::get('/heritage_financial/view_loan/{uuid?}', [LoansController::class, 'view_loan']) -> middleware(['loan_officer']);
