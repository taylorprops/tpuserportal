    ...
    <table class="w-full divide-y divide-gray-200">
        ...
        <thead class="bg-gray-50">
            <tr id="sortable_tr">
                ...
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">@sortablelink('loan_officer_1_commission_amount', 'Commission Amount')</th>
            </tr>
        </thead>
        <tbody class="bg-white divide-y divide-gray-200">
            @foreach($loans as $loan)
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-gray-500">${{ number_format($loan -> loan_officer_1_commission_amount) }}</td>
                </tr>
            @endforeach
        </tbody>
