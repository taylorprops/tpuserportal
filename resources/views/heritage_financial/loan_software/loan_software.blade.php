            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="rounded-lg border">
                    ...
                    <div class="p-4">
                        ...
                        <div class="py-2">
                            Website - <a href="https://prod.lendingpad.com/heritage-financial/login" target="_blank">https://prod.lendingpad.com/heritage-financial/login</a>
                        </div>
                        ...
                        <div class="ml-4">
                            ...
                            <ul class="list-disc list-inside my-4 ml-4">
                                ...
                                <li>Email <a href="mailto:support@lendingpad.com" target="_blank">support@lendingpad.com</a> </li>
                        ...
                        <div class="ml-4">
                            ...
                            <div>
                                You will be auto-enrolled in these training classes depending on your user role.  The sign up links are also available under <a href="https://prod.lendingpad.com/web/?#/support" target="_blank">Support</a> / <a href="https://prod.lendingpad.com/web/?#/support/training" target="_blank">Training page</a>.  Ask questions and practice hands-on.  You will learn how easy it is to originate in LendingPad.
                            </div>
                            ...
                            <ul class="list-disc list-inside my-4 ml-4">
                                <li>Subscribe to Lending Pad's YouTube channel <a href="https://www.youtube.com/channel/UCLHJssI1cOLeHNNnSKkQbDw/videos" target="_blank">YouTube Channel</a></li>
                                <li><a href="https://www.youtube.com/watch?v=8JhK7x_c0bs" target="_blank">How to take an application</a></li>
                                <li><a href="https://www.youtube.com/watch?v=UCcluykgDPo" target="_blank">How to pull a credit report</a></li>
                                <li><a href="https://www.youtube.com/watch?v=DZVM3OyDd1k" target="_blank">How to run AUS</a></li>
                                <li><a href="https://www.youtube.com/watch?v=1ZdEI24liB8" target="_blank">How to issue a pre-approval Letter</a></li>
                                <li><a href="https://www.youtube.com/watch?v=1ZdEI24liB8" target="_blank">How to use document management features</a></li>
                                <li><a href="https://www.youtube.com/watch?v=zxn6lIs3gCw" target="_blank">How to use support center</a></li>
                            </ul>
