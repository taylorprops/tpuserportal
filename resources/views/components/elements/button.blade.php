...
$classes .= ' bg-'.$buttonClass.' hover:bg-'.$buttonClass.'-dark active:bg-'.$buttonClass.'-dark focus:border-'.$buttonClass.'-dark ring-'.$buttonClass.'-dark inline-flex items-center rounded tracking-wider text-white shadow hover:shadow-lg outline-none focus:outline-none focus:ring disabled:opacity-25 transition-all ease-in-out duration-150 shadow hover:shadow-md ';
@endphp
