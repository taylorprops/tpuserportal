<select x-cloak {!! $attributes -> merge([]) !!} x-ref="select" class="hidden">
    {{ $slot }}
</select>

<div x-data="dropdown($refs.select)" x-init="loadOptions()"
    class="w-full flex flex-col items-center h-64 mx-auto">
    <input name="values" type="hidden" x-bind:value="selectedValues()">
    <div class="inline-block relative w-64">
        <div class="flex flex-col items-center relative">
            <div x-on:click="open" class="w-full">
                <div
                    class="flex bg-white text-gray-800 p-1 w-full shadow-sm focus:ring-blue-200 focus:ring-2 focus:border-blue-200 focus:bg-blue-50 sm:text-sm border rounded placeholder-gray-600">
                    <div class="flex flex-auto flex-wrap">
                        ...
                        <div x-show="selected.length == 0" class="flex-1">
                            <input placeholder="Select a option"
                                class="bg-transparent py-0 px-2 appearance-none outline-none h-full w-full text-gray-800"
                                ...
                                <div
                                    ...
                                    <div class="w-full items-center flex justify-between">
                                        ...
                                        <div x-show="option.selected">
                                            <svg class="select svg-icon" viewBox="0 0 20 20">
                                                <path fill="none"
