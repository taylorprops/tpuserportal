<x-app-layout>
    ...
    <div class="create-div pb-36 pt-2"
    ...
    x-init="
        ...
        <div class="max-w-screen-lg mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white md:mt-4 lg:mt-12 shadow-sm sm:rounded-lg">
                    ...
                    <div class="py-6 md:py-8">
                        ...
                        <div x-show.transition="active_step === 1">
                            ...
                            <div class="py-6 md:pb-16 bg-white">
                                ...
                                {{-- Final Result --}}
                                <div class="border border-secondary mt-12 rounded text-gray-600 w-2/3 mx-auto"
                                id="final_results"
                        ...
                        <div x-show.transition="active_step === 2">
                            ...
                            <form id="checklist_details_div">
                                ...
                                <div class="text-lg text-gray-600 my-4">Please provide the following details</div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                                    ...
                                    <div>
                                        ...
                                        @change="property_type_selected()">
                                            <option value=""></option>
                                            <template x-for="prop_type in property_types">
                                                <option :value="prop_type" x-text="prop_type"></option>
                                            </template>
                                    ...
                                    x-show="for_sale === 'yes'">
                                        ...
                                        @change="property_type_selected()">
                                            <option value=""></option>
                                            <template x-for="property_sub_type in property_sub_types">
                                                <option :value="property_sub_type" x-text="property_sub_type"></option>
                                            </template>
                            ...
                            <div>
                                ...
                                <form id="create_form">
                                    ...
                                    <div class="lg:w-5/6 mx-auto">
                                        ...
                                        <div class="relative">
                                            <div class="border bg-white p-2 absolute top-1"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mt-5">
                                            ...
                                            <div class="col-span-1 md:col-span-2">
                                                <x-elements.input
                                                class="required"
                                                id="ListAgentOfficeName"
                                                name="ListAgentOfficeName"
                                        ...
                                        <input type="hidden" id="ListAgentOfficeStreet" name="ListAgentOfficeStreet">
                                        <input type="hidden" id="ListAgentOfficeCity" name="ListAgentOfficeCity">
                                        <input type="hidden" id="ListAgentOfficeState" name="ListAgentOfficeState">
                                        <input type="hidden" id="ListAgentOfficeZip" name="ListAgentOfficeZip">
                                    ...
                                    x-show="for_sale === 'yes'">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mt-5">
                                            ...
                                            <div class="col-span-1">
                                                ...
                                                name="EarnestAmount"
                                                type="text"
                                                class="money numbers-only required"
        ...
        x-show="show_add_contact_modal">
            ...
            <table id="contacts_table" class="data-table hover nowrap order-column row-border text-gray-600 animate__animated animate__fadeIn hidden" width="100%">
                <thead>
                    <tr>
                        <th></th>
                        <th>Name</th>
    ...
    <template id="agent_search_result_template">
        <li class="px-2 py-3 border-b cursor-pointer text-gray-600 hover:text-secondary"
