...
{{-- blade-formatter-enable --}}
        ...
        <li class="form-group-li border border-b p-3 w-full @if ($loop -> first) active @endif" x-show="active_tab === '{{ $form_group_id }}'"
            ...
            <div class="flex justify-between items-center mb-5">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        <select class="form-element select md sort-by" data-label="Sort By" x-on:change="get_forms()">
                    ...
                    <div class="ml-2">
                        <select class="form-element select md show-published" data-label="Published" x-on:change="get_forms()">
                    ...
                    <div class="ml-2">
                        <select class="form-element select md show-active" data-label="Active" x-on:change="get_forms()">
