<x-app-layout>
    ...
    <div class="page-container h-screen" x-data="fields()">
        ...
        <div class="w-full p-2 flex justify-around h-screen-8">
            ...
            <div class="flex items-center">
                ...
                <div class="flex-auto px-2">
                    ...
                    <button type="button" class="button primary md field-button" data-type="textbox"
                ...
                <div class="flex-auto px-2">
                    ...
                    <button type="button" class="button primary md field-button" data-type="date"
                ...
                <div class="flex-auto px-2">
                    ...
                    <button type="button" class="button primary md field-button" data-type="number"
                ...
                <div class="flex-auto px-2">
                    ...
                    <button type="button" class="button primary md field-button" data-type="checkbox"
                ...
                <div class="flex-auto px-2">
                    ...
                    <button type="button" class="button primary md field-button" data-type="radio"
                ...
                <div class="flex-auto px-2">
                    ...
                    <button type="button" class="button success lg" data-type="radio" @click="save_fields($event.currentTarget)">
        ...
        <div class="grid grid-cols-9 w-full" x-data="">

            <div class="col-span-8">

                <div class="h-screen-92 overflow-y-auto pb-56 forms-container" data-form-id="{{ $form_id }}">
...
{{-- blade-formatter-enable --}}
                            ...
                            <div class="form-page-container page-{{ $page_number }} relative border" data-page="{{ $page_number }}" @dblclick.stop.prevent="add_field($event)">
...
{{-- blade-formatter-enable --}}
                    ...
                    <div class="thumb-header-{{ $page_number }} w-3/4 mx-auto relative mb-2 cursor-pointer hover:shadow-md" {{-- :class="{ 'opacity-30' : active_page !== {{ $page_number }}, 'opacity-100' : active_page === {{ $page_number }} }" --}}>
        ...
        <template id="field_template" class="hidden">
            ...
            <div class="field-div absolute" id="field_%%id%%" data-id="%%id%%" data-category="%%category%%" data-common-field-id="" data-group-id="%%id%%" x-data="{
                field_category: '%%category%%'
            }"
                {{-- x-bind:data-number-type="number_type_%%id%%" --}} style="top: %%y_perc%%%; left: %%x_perc%%%; height: %%h_perc%%%; width: %%w_perc%%%;" x-bind:class="{ 'z-50': active_field === '%%id%%' }"
                x-init="draggable($el, '%%category%%'),
                    resize($el)"
                @click.stop="
                active_field = '%%id%%';
                set_options_side($el);
                ...
                resize($el)"
                @click.outside="active_field = ''" @dblclick.stop.prevent>
                ...
                <div class="resizers">
                    ...
                    <div class="group-label text-white h-1.5 w-1.5 rounded-full hidden z-20" style="background: %%group_color%%"
                ...
                <div class="" x-bind:class="{ 'left-0 right-auto': options_side === 'left', 'right-0 left-auto': options_side === 'right' }"
                    ...
                    <div class="" :class="{ 'left-0 right-auto': options_side === 'left', 'right-0 left-auto': options_side === 'right' }">
                        ...
                        <div class="absolute -bottom-10 w-max" :class="{ 'left-0': options_side === 'left', 'right-0': options_side === 'right' }">

                            <div class="flex justify-start items-center" :class="{ 'flex-row': options_side === 'left', 'flex-row-reverse': options_side === 'right' }">

                                <button type="button" class="button primary sm" x-show="field_category !== 'radio'"
                                    x-bind:class="{ 'mr-2': options_side === 'left', 'ml-2': options_side === 'right' }" @click="active_field = ''; copy_field('%%id%%', false);">
                                    <i class="fal fa-copy mr-2"></i> Copy
                                </button>

                                <button type="button" class="button primary sm" x-show="field_category !== 'checkbox' && field_category !== 'date'"
                                    @click="active_field = ''; copy_field('%%id%%', true);">
                                    <i class="fal fa-plus mr-2"></i> Add To Group
                                </button>

                                <button type="button" class="button danger sm mr-2" @click="remove_field(%%id%%)">
                    ...
                    <div class="field-div-options absolute -bottom-14 w-max"
                        ...
                        <div class="p-4 bg-white border-2 shadow absolute w-96 rounded"
                            ...
                            <div class="grid grid-cols-2" x-show="field_category === 'number'" x-data="{
                                number_type: ''
                            }">

                                <div class="p-2 rounded" :class="{ 'bg-blue-200': number_type === 'numeric' }">
                                    <div class="mb-2">
                                        <input type="radio" class="form-element radio md number-type" name="number_type_radio_%%id%%" id="numeric_%%id%%" value="numeric"
                                            data-label="Numeric" x-on:change="number_type = $el.checked ? 'numeric' : 'written';">
                                    </div>
                                ...
                                <div class="p-2 rounded" :class="{ 'bg-blue-200': number_type === 'written' }">
                                    <div class="mb-2">
                                        <input type="radio" class="form-element radio md number-type" name="number_type_radio_%%id%%" id="written_%%id%%" value="written"
                                            data-label="Written" x-on:change="number_type = $el.checked ? 'written' : 'numeric';">
                                    </div>
                            ...
                            <div class="my-3" x-show="field_category === 'number'">
                                <hr>
                            </div>
                            ...
                            <div class="grid grid-cols-6 mb-3 place-content-center">
                                ...
                                <div class="col-span-5">
                                    <input type="text" class="form-element input md common-field-input input-%%id%%" placeholder="Select Shared Name Below" data-label=""
                                        readonly>
                                    <input type="hidden">
                                </div>
                                <div class="col-span-1 ml-2 flex items-center">
                                    <button type="button" class="button danger md no-text clear-common-field-input"
...
{{-- blade-formatter-enable --}}
                                        ...
                                        <div class="mx-1 relative" x-show="field_category === '{{ $type }}'">

                                            <div x-data="{ field_options: false }" @mouseover="field_options = true" @click="field_options = true"
                                                ...
                                                <div class="absolute top-5 left-0 pt-3" x-show="field_options" x-transition>
                                                        ...
                                                        @if (count($data -> sub_groups) > 0)
                                                            @foreach ($data -> sub_groups as $sub_group)
                                                                <li class="custom-dropdown p-2 border-b w-48 cursor-pointer hover:bg-blue-100 relative">
                                                                    ...
                                                                    <ul
                                                                        class="custom-dropdown-content absolute hidden bg-blue-100 p-3 @if ($label == 'Offices') -left-56 @else left-48 @endif top-0 border shadow rounded w-max">
                                                                        @foreach ($sub_group -> common_fields as $field)
                                                                            <li class="common-field py-1 px-2 border-b w-56 cursor-pointer bg-white hover:bg-blue-200"
                                                                                data-id="{{ $field -> id }}" data-name="{{ $field -> field_name }}"
                                                        ...
                                                        @else
                                                            @foreach ($data -> common_fields as $field)
                                                                <li class="common-field custom-dropdown p-2 border-b w-48 cursor-pointer hover:bg-blue-100 relative"
                                                                    data-id="{{ $field -> id }}" data-name="{{ $field -> field_name }}"
                                                                    data-db-column-name="{{ $field -> db_column_name }}" data-field-type="{{ $field -> field_type }}"
                                                                    data-common-field-group-id="{{ $field -> group_id }}"
                                                                    data-common-field-sub-group-id="{{ $field -> sub_group_id }}"
                                                                    @click.stop="field_options = false; select_common_field($event);">
