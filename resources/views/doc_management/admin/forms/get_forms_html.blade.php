...
{{-- blade-formatter-enable --}}
        ...
        <li class="form-{{ $form_id }} p-3 w-full"
            ...
            <div class="flex justify-start items-center mt-3">
                ...
                <div class="ml-3">
                    <button type="button" class="button primary sm" @click="active_form = '{{ $form_id }}'">
                ...
                <div class="ml-3">
                    <button type="button" class="button primary sm" @click="active_form = '{{ $form_id }}'; duplicate_form(`{{ $form_id }}`)">
                        <i class="fad fa-copy mr-2"></i> Duplicate
                    </button>
                </div>

                <div class="ml-3">
                    <button type="button" class="button success sm" @click="active_form = '{{ $form_id }}'; publish_form(`{{ $form_id }}`)">
                        <i class="fad fa-file-export mr-2"></i> Publish
                    </button>
                </div>

                <div class="ml-3">
                    <button type="button" class="button danger sm" @click="delete_form(`{{ $form_id }}`)">
