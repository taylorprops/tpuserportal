                            ...
                            <div class="mb-12">
                                ...
                                <div class="hidden sm:block">
                                    ...
                                    <nav class="flex space-x-4" aria-label="Tabs">
                                        ...
                                        :class="{ 'bg-primary-lightest text-primary': active_mortgage_tab === 1, 'text-gray-500 bg-white hover:text-gray-700': active_mortgage_tab !== 1 }">
                                            Meeting Reports
                                        </a>

                                        <a href="#" class="text-gray-500 hover:text-gray-700 px-3 py-2 font-medium text-sm rounded-md"
                                        @click="active_mortgage_tab = 2"
                                        :class="{ 'bg-primary-lightest text-primary': active_mortgage_tab === 2, 'text-gray-500 bg-white hover:text-gray-700': active_mortgage_tab !== 2 }">
                                            Detailed Report
                                        </a>
                                                        ...
                                                        <tbody class="bg-white divide-y divide-gray-200">
                                                            <tr>
                                                                ...
                                                                <td colspan="2" class="p-2">
                                                                    <button type="button" class="button primary md" @click="print_report($el, null);" :disabled="!show_print_all_option">
                                                            ...
                                                            <tr>
                                                                <td class="p-2">
                                                                    <div class="flex justify-around items-center">
                                                                        <input type="checkbox" class="form-element checkbox success md report-checkbox" data-report="{{ $report }}" @click="show_print_all_button()">
                                                                    </div>
                                                                </td>
                                                                <td class="p-2">
