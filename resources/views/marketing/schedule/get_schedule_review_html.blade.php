            ...
            <div>
                ...
                <div class="flex justify-between items-center px-2 py-1 text-gray-500 w-full">
                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 pr-4 border-r w-28 text-right">
                            Preview Text
                        </div>

                        <div class="shrink px-4">
                            {{ $event -> preview_text }}
                        </div>
                    ...
                    <div>
                        ...
                        <div x-show="show_notes">
                            <button type="button" class="whitespace-nowrap bg-red-100 text-red-500 hover:text-red-600 p-1 pl-2 flex items-center rounded-full"
