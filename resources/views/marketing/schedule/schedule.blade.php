...
<x-app-layout>
    ...
    <div class="overflow-hidden" x-data="schedule()">
            ...
            <form x-ref="filter_form">
                ...
                <div class="my-6 flex items-end justify-start space-x-4">
                    ...
                    @foreach (['company', 'recipient', 'medium', 'status'] as $item)
                        <div>
                            <select class="form-element select md" data-label="{{ ucwords($item) }}"
                                name="{{ $item }}_id" @change="get_schedule()">
                    ...
                    <div class="lg:h-screen-80 relative lg:overflow-y-auto">
                        ...
                        <div x-show="show_html || show_file">
                            ...
                            <div class="absolute top-12 right-12 z-20"><a href="javascript:void(0)"
                                    @click="show_html = false; show_file = false; show_calendar = true;"><i
                                        class="fa-duotone fa-circle-xmark fa-3x text-red-600 hover:text-red-500"></i></a>
                            </div>

                            <div class="absolute top-0 z-10 h-full w-full border-4 bg-white" x-show="show_html"
                                x-ref="view_html">
                                <iframe class="view-accepted-iframe" width="100%" height="100%"></iframe>
                            </div>

                            <div class="absolute top-0 z-10 h-full w-full bg-white" x-show="show_file">
                                <embed src="" type="application/pdf" class="min-h-750-px" width="100%" height="100vh"
                                    x-ref="view_file" />
                            </div>
        ...
        <x-modals.modal :modalWidth="'w-full sm:w-11/12 md:w-3/4 lg:w-1/2'" :modalTitle="'Add/Edit Marketing Item'" :modalId="'show_item_modal'" x-show="show_item_modal"
            ...
            <form x-ref="schedule_form" enctype="multipart/form-data">
                ...
                <div class="p-2 sm:p-4 lg:p-8 lg:pt-0">
                    ...
                    <div class="mt-4 w-48">
                        <select class="form-element select md required" name="status_id" x-ref="status_id"
                            data-label="Status">
                            <option value=""></option>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-9">
                        ...
                        <div class="col-span-2">
                            <input type="date" class="form-element input md required" name="event_date"
                                x-ref="event_date" data-label="Event Date">
                        </div>

                        <div class="col-span-3">
                            <select class="form-element select md required" name="recipient_id" x-ref="recipient_id"
                                data-label="Recipient" @change="
                        ...
                        <div class="col-span-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                @foreach ($states as $state)
                                    <div>
                                        <input type="checkbox" class="states form-element checkbox primary lg states"
                                            name="state[]" id="{{ $state }}" value="{{ $state }}"
                                            data-label="{{ $state }}" @change="update_states()">
                                    </div>
                                @endforeach
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-4">
                        ...
                        <div class="">
                            <select class="form-element select md required" name="company_id" x-ref="company_id"
                                data-label="Company">
                                <option value=""></option>
                        ...
                        <div class="">
                            <select class="form-element select md required" name="medium_id" x-ref="medium_id"
                                data-label="Medium"
                        ...
                        <div class="col-span-4">
                            <input type="text" class="form-element input md required" name="description"
                                x-ref="description" data-label="Description">
                        </div>

                        <div class="col-span-2" x-show="show_email_options">
                            <input type="text" class="form-element input md" name="subject_line_a"
                                x-ref="subject_line_a" data-label="Subject Line A">
                        </div>

                        <div class="col-span-2" x-show="show_email_options">
                            <input type="text" class="form-element input md" name="subject_line_b"
                                x-ref="subject_line_b" data-label="Subject Line B">
                        </div>

                        <div class="col-span-4" x-show="show_email_options">
                            <input type="text" class="form-element input md" name="preview_text" x-ref="preview_text"
                            ...
                            <div class="hidden sm:block">
                                <div class="border-b border-gray-200">
                                    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                                        ...
                                        <a href="#" class="whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium"
                                            :class="active_tab === 'html' ? 'border-primary text-primary' :
                                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300';"
                                            @click="active_tab = 'html'"> HTML </a>

                                        <a href="#" class="whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium"
                                            aria-current="page" @click="active_tab = 'file'"
                            ...
                            <div class="mt-8">
                                ...
                                <div x-show="active_tab === 'html'" x-transition>
                                    <div class="flex w-full items-end">
                                        ...
                                        <div class="ml-2">
                                            <button type="button" class="button primary md">Get HTML <i
                                                    class="fa-light fa-arrow-right ml-2"></i></button>
                                        </div>
                                    </div>
                                    <div class="my-2">OR</div>
                                    <div>
                                        <textarea class="form-element textarea md" rows="3" name="upload_html" data-label="Paste HTML" x-ref="upload_html"
                                ...
                                <div x-show="active_tab === 'file'" x-transition>
                                    <div>
                                        <input type="file" name="upload_file" class="form-element input md"
                                            @change="show_file_names($el);"
                                            accept="image/x-png,image/gif,image/jpeg,application/pdf"
                                            x-ref="upload_file" @click="$refs.upload_html.value = ''">
                                    </div>
                                </div>
                    ...
                    <div class="flex items-center justify-around">
                        ...
                        <div class="mt-4 flex justify-around" x-show="edit_event">
                            <a href="javascript:void(0)" class="text-red-600 hover:text-red-500"
                        ...
                        <div class="flex items-center justify-around pb-6 pt-12">
                            <button type="button" class="button primary xl" @click="save_item($el)">Save Item <i
        ...
        <x-modals.modal :modalWidth="'w-screen-95'" :modalTitle="''" :modalId="'show_versions_modal'" x-show="show_versions_modal"
            :clickOutside="'show_versions_modal = true;'">
            <div x-ref="versions_div"></div>
        </x-modals.modal>

        <x-modals.modal :modalWidth="'w-full sm:w-3/4 md:w-1/3 lg:w-1/4'" :modalTitle="''" :modalId="'show_delete_event_modal'" x-show="show_delete_event_modal"
        ...
        <x-modals.modal :modalWidth="'w-full sm:w-11/12 md:w-3/4 lg:w-1/2'" :modalTitle="'Add New Version'" :modalId="'show_add_version_modal'" x-show="show_add_version_modal">
                ...
                <div class="hidden sm:block">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                            ...
                            <a href="#" class="whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium"
                                aria-current="page" @click="active_tab = 'file'; clear_add_version_form()"
                                :class="active_tab === 'file' ? 'border-primary text-primary' :
                                    'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300';">
                                PDF/Image </a>
                ...
                <form id="add_version_form">
                    ...
                    <div class="mt-8">
                        ...
                        <div x-show="active_tab === 'html'" x-transition>
                            ...
                            <div class="my-2">OR</div>
                            <div>
                                <textarea class="form-element textarea md" rows="3" name="upload_version_html" data-label="Paste HTML"
                        ...
                        <div x-show="active_tab === 'file'" x-transition>
                            <div class="mt-12">
                                <input type="file" name="upload_version_file" class="form-element input md"
                                    @change="show_file_names($el)" x-ref="upload_version_file"
                                    accept="image/x-png,image/gif,image/jpeg,application/pdf">
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-around pb-6 pt-12">
                <button type="button" class="button primary xl" @click="save_add_version($el, true)">Save Version <i
                        class="fa-light fa-check ml-2"></i></button>
            </div>
        ...
        <x-modals.modal :modalWidth="'w-full sm:w-11/12 md:w-3/4 lg:w-1/2'" :modalTitle="'Email Item'" :modalId="'show_email_modal'" x-show="show_email_modal">
            ...
            <form id="email_form">
                ...
                <div x-data="{ active: 'a' }">
                    ...
                    <div class="relative my-4" x-data="{ show_to_options: false }" @click.outside="show_to_options = false">
                        ...
                        <div class="z-100 to-list absolute top-10 left-28 divide-y rounded-lg bg-white p-2 shadow"
                            ...
                            <div class="flex justify-around p-2">
                                <a href="javascript:void(0)" class="text-sm text-red-600 hover:text-red-500"
                    ...
                    <div x-show="show_subject_options">
                            ...
                            <div class="my-4">
                                <div class="mt-1 flex w-full">
                                    <div class="flex w-full rounded-md shadow-sm">
                                        <div
                                            class="inline-flex w-28 items-center justify-end rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 text-gray-500 sm:text-sm">
                                            <div class="flex items-center justify-around pr-2">
                                                <input type="radio" class="form-element radio md"
                                                    id="input_{{ $subject }}" name="subject_option"
                                                    value="{{ $subject }}"
                                        ...
                                        <input type="text" name="email_subject_line_{{ $subject }}"
                        ...
                        <div class="my-4">
                            ...
                            <div class="flex w-full rounded-md shadow-sm">
                                ...
                                <input type="text" name="email_preview_text" id="email_preview_text"
                                    class="block w-full min-w-0 flex-1 rounded-none rounded-r-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    ...
                    <div x-show="!show_subject_options">
                        <input type="text" name="email_subject" class="form-element input md" x-ref="email_subject"
                            placeholder="Subject">
                    </div>

                    <div class="mt-12 mb-8 flex items-center justify-around">
                        <button type="button" class="button primary lg" @click="send_email($el)">Send Email <i
                                class="fa-solid fa-share ml-2"></i></button>
                    </div>
