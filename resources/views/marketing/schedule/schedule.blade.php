                    ...
                    <div class="lg:h-screen-80 relative lg:overflow-y-auto">
                        ...
                        <div x-show="show_html || show_file">
                            ...
                            <div class="absolute top-12 right-12 z-20"><a href="javascript:void(0)"
                                @click="hide_view_div(); active_event = '';"><i class="fa-duotone fa-circle-xmark fa-3x text-red-600 hover:text-red-500"></i></a>
                            </div>

                            <div class="absolute top-0 z-10 h-full w-full border-4 bg-white"
                                x-show="show_html"
                                x-ref="view_html">
                                <div x-ref="view_details_html" class="p-4"></div>
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-4">
                        ...
                        <div class="col-span-4"
                            ...
                            <textarea rows="2"
                                ...
                                name="tracking_code"
                                x-ref="tracking_code"
                                data-label="Tracking Code"></textarea>
                        </div>
