                    ...
                    <form id="options_form">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex justify-end items-center space-x-3"
                                x-show="list_type === 'emails' && list_group != 'test_center_selected'">
                        ...
                        <div class="my-6 p-4 border rounded-lg">
                            ...
                            <p class="text-sm leading-5 text-gray-500 mt-4">Is this for Emails or
                                Home Addresses?</p>
                            ...
                            <div class="flex flex-wrap justify-start">
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-2 flex justify-between">
                                        ...
                                        <span
                                            class="bg-yellow-600 rounded-full py-1 px-3 text-xs text-white inline-block"><span
                                                id="state_count"></span> Selected</span>
                                    </div>
                                ...
                                <div class="ml-8"
                                    ...
                                    <div class="mt-2 flex justify-between">
                                        ...
                                        <span
                                            class="bg-yellow-600 rounded-full py-1 px-3 text-xs text-white inline-block"><span
                                                id="county_count"></span> Selected</span>
                                    </div>
                            ...
                            <div class="flex justify-start items-end">
                                ...
                                <div class="ml-2 mb-1.5">
                                    <button type="button" class="button secondary sm"
                                        @click="$refs.office_name.value = ''; clear_office_search_results();">Clear
                                        <i class="fal fa-times ml-2"></i></button>
                                </div>
                ...
                <div class="col-span-1">
                    ...
                    <div class="border-4 border-blue-200 mt-12 p-4 rounded-lg relative">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <input type="date" class="form-element input md"
                                    x-ref="recently_added_emails_start" data-label="Start Date">
                            </div>

                            <div>
                                <input type="date" class="form-element input md"
                                    x-ref="recently_added_emails_end" data-label="End Date">
                            </div>
                        ...
                        <div class="mt-6 flex justify-around">
                            <button type="button" class="button primary lg"
                                @click="get_recently_added()"><i class="fa fa-download mr-2"></i>
                                Download Recently Added</button>
                        </div>
                    ...
                    <div class="border-4 border-red-200 mt-12 p-4 rounded-lg relative">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <input type="date" class="form-element input md"
                                    x-ref="purged_emails_start" data-label="Start Date">
                            </div>

                            <div>
                                <input type="date" class="form-element input md"
                                    x-ref="purged_emails_end" data-label="End Date">
                            </div>
