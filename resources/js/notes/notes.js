    ...
    return {
        ...
        notes_editor(ele) {
            ...
            let options = {
                ...
                menubar: '',
                statusbar: false,
                quickbars_selection_toolbar: 'bold italic | bullist | formatselect | quicklink blockquote',
                plugins: ['image', 'table', 'code', 'hr', 'autoresize', 'paste', 'lists', 'quickbars'],
                toolbar: 'undo redo | table | bold italic underline hr | forecolor backcolor |  align outdent indent |  bullist | image | formatselect fontselect fontsizeselect | paste | code |',
